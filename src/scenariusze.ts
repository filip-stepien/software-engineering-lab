...
const scenarios: Array<Usecase> = [
    {
        ...
        preconditions: ['Pracownik musi być zalogowany w systemie'],
        ...
        mainFlow: [
            ...
            {
                num: 5,
                text: 'Pracownik zatwierdza operację.'
            },
            {
                num: 6,
            ...
            {
                num: 10,
                text: 'System wysyła login i tymczasowe hasło dostępu do klienta.'
            },
            {
                num: 11,
        ...
        alternateFlow: [
            {
                num: 5,
                text: 'Pracownik wybiera opcje "Anuluj". END FLOW'
            },
            {
                num: 6,
    ...
    },
    {
        ...
        preconditions: [
            ...
            'Pracownik musi być zalogowany w systemie'
        ],
        ...
        alternateFlow: [
            ...
            {
                num: 9,
                text: 'Pracownik wybiera opcję "Anuluj". END FLOW'
            }
        ]
    },
    {
        ...
        mainFlow: [
            ...
            {
                num: 6,
                text: 'System generuje informację zwrotną dla klienta'
            }
        ],
        alternateFlow: [
            {
                num: 2,
                text: 'Nie znaleziono przedawnionego karnetu. END FLOW'
            },
            {
                num: 3,
                text: 'Metoda płatnicza niedostępna - unieważnienie karnetu. END FLOW'
            }
        ]
    },
    {
        ...
        mainFlow: [
            ...
            {
                num: 9,
                text: 'Pracownik zatwierdza zmiany.'
            },
            {
                num: 10,
                text: 'System sprawdza czy wprowadzone dane mają prawidłowy format'
    ...
    },
    {
        ...
        mainFlow: [
            ...
            {
                num: 5,
                text: 'System sprawdza czy istnieje użytkownik z podanym logiem i hasłem'
            },
            {
                num: 6,
        ...
        alternateFlow: [
            {
                num: 5,
                text: 'Błędne dane logowania - system wyświetla komunikat o błędzie. POWRÓT DO 2'
            }
        ]
    },
    {
    ...
    },
    {
        ...
        preconditions: ['Trener jest zalogowany w systemie', 'Klient istnieje w systemie'],
        postconditions: [
