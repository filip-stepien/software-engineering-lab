...
const scenarios: Array<Usecase> = [
    {
        ...
        mainFlow: [
            {
                num: 1,
                text: 'Client requests the employee to create a membership',
            },
            { num: 2, text: 'Employee selects the `New membership` option' },
            { num: 3, text: 'System displays a form to create a membership' },
            {
                num: 4,
                text: 'Employee enters the client’s personal, payment, and contact details in the form',
            },
            { num: 5, text: 'Employee selects the `Save` option' },
            {
                num: 6,
                text: 'System checks if the entered data is correctly formatted',
            },
            {
                num: 7,
                text: 'System checks if the payment method is available',
            },
    ...
    },
    {
        ...
        mainFlow: [
            {
                num: 1,
                text: 'Client requests the employee to cancel their membership',
            },
            { num: 2, text: 'Employee selects the `View memberships` option' },
            { num: 3, text: 'System displays the list of memberships' },
            {
                num: 4,
                text: 'Employee enters the client’s data in the search bar',
            },
            { num: 5, text: 'System displays options matching the search' },
            {
                num: 6,
                text: 'Employee selects the membership from the search results',
            },
            ...
            {
                num: 11,
                text: 'System generates a confirmation of the operation',
            },
        ],
        alternateFlow: [{ num: 5, text: 'Client not found. RETURN TO 3' }],
    },
    {
        author: {
            name: 'Filip',
        ...
        mainFlow: [
            {
                num: 1,
                text: 'System checks the expiration date of user memberships',
            },
            { num: 2, text: 'System finds an expired membership' },
            {
                num: 3,
                text: 'System checks if the payment method for renewing the membership is available',
            },
    ...
    },
    {
        ...
        mainFlow: [
            {
                num: 1,
                text: 'Client requests the employee to update membership data',
            },
            { num: 2, text: 'Employee selects the `View memberships` option' },
            { num: 3, text: 'System displays the list of memberships' },
            {
    ...
    },
    {
        ...
        alternateFlow: [{ num: 5, text: 'User not found. RETURN TO 2' }],
    },
    {
        author: {
            name: 'Rafał',
    ...
    },
    {
        ...
        preconditions: ['none'],
        postconditions: [
            'File with report on conducted training sessions created',
        ],
        actors: ['manager'],
        mainFlow: [
    ...
    },
    {
        ...
        preconditions: [
            'Client logged into the system',
            'Trainer logged into the system',
        ],
        postconditions: [
            "Client's message reaches trainer, and trainer can respond",
        ],
        actors: ['client'],
        mainFlow: [
            {
